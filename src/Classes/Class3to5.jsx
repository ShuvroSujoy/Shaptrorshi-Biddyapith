        ...
        <div className='container'>
            <div className='flex md:flex-row flex-col-reverse gap-5 mt-10 mb-10 '>
                ...
                <div className='flex flex-col gap-y-5'>
                    <h1 className='md:text-4xl text-2xl text-black font-bold'>২০২৪ শিক্ষাবর্ষের ৩য় থেকে ৫ম শ্রেণীতে ভর্তি চলছে</h1>
                    <p className='text-base text-gray-500 header-text-width'>বাংলাদেশের যেকোনো প্রান্তের ৩য় থেকে ৫ম শ্রেণির শিক্ষার্থীদের পড়লেখায় সাহায্য করতে, নতুন জাতীয় শিক্ষাক্রম অনুযায়ী পড়াশোনার সবকিছু নিয়ে সাজানো হয়েছে ৩য় থেকে ৫ম - ব্যাচ ২০২৪।</p>
                            ...
                            <div className='md:grid md:grid-cols-2 grid grid-cols-1 gap-x-5 gap-y-2'>
                                ...
                                <div className='flex items-start gap-x-3'>
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <p className='text-black font-normal text-base text-width'>- ৩য় থেকে ৫ম শ্রেণির টপিক ভিক্তিক ক্লাসের মাধ্যমে জ্ঞান, অনুধাবন ও প্রয়োগমূলক শিক্ষা অর্জন হবে</p>
                                    </div>
                                </div>
                            </div>
                            {/* 3rd */}
                            <div className='md:grid md:grid-cols-2 grid grid-cols-1 gap-x-5 gap-y-2'>
                                ...
                                <div className='flex items-start gap-x-3'>
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <p className='text-black font-normal text-base text-width'>- ৩য় থেকে ৫ম শ্রেণির পাঠ্যক্রমের বেসিক প্রিপারেশন যাচাই করার জন্য প্র্যাকটিস করতে পারবে</p>
                                    </div>
                                </div>
                            </div>
                            {/* 4rth */}
                            ...
                            <div className='md:grid md:grid-cols-2 grid grid-cols-1 gap-x-5 gap-y-2'>
                                <div className='flex items-start gap-x-3'>
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <p className='text-black font-normal text-base text-width'>-৩য় থেকে ৫ম শ্রেণির পড়াশোনার পাশাপাশি স্কিল সেশনসহ গণিত, বিজ্ঞান ও ইংরেজি অলিম্পিয়াড, সাংস্কৃতিক, ইনডোর গেম বিভিন্ন প্রতিযোগীতা আয়োজন করা হবে</p>
                                    </div>
                                </div>
                                <div className='flex items-start gap-x-3'>
                                    <IoIosCheckmark size={40} className='text-red-800' />
                                    <div className='flex flex-col'>
                                        ...
                                        <p className='text-black font-normal text-base text-width'>-৩য় থেকে ৫ম শ্রেণির শিক্ষার্থীদের জন্য থাকবে প্রোগ্রেস কার্ড</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <details className='border-b-2 pb-3'>
                                ...
                                <div className='px-5 py-3 mt-2  '>
                                    <ul className='list-disc text-base text-gray-500 header-text-width space-y-3'>
                                        <li>৩য় থেকে ৫ম শ্রেণির নতুন কারিকুলাম অনুযায়ী একাডেমিক লাইফে সঠিক পড়াশুনার রুটিন থাকবে</li>
                                        <li>৩য় থেকে ৫ম শ্রেণির বইয়ের শিখনফলগুলো বাস্তব জীবনে প্রয়োগ করতে পারবে</li>
                                        <li>টপিকের বেসিক প্রিপারেশন যাচাই করার জন্য ডেইলি প্র্যাকটিস করতে পারবে</li>
                                        <li>৩য় থেকে ৫ম শ্রেণির ডেমো অ্যাসাইনমেন্ট (একক ও দলীয়) প্র্যাকটিস করতে পারবে</li>
                                        <li>৩য় থেকে ৫ম শ্রেণির সিলেবাস ভিত্তিক যেকোনো ডাউট সল্ভ করতে পারবে</li>
                                        <li>ঘরে বসেই দেশসেরা শিক্ষকের সাথে লেখাপড়া করতে পারবে</li>
                                    </ul>
                                </div>
                            </details>
                            <details className=''>
                                <summary className='text-zinc-600 text-[18px] font-semibold'>৩য় থেকে ৫ম শ্রেণির শিখন বিষয়</summary>
                                <div className='px-5 py-3 mt-2'>
                                    <ul className='list-disc text-base text-gray-500 header-text-width space-y-3'>
                    ...
                    <div className='space-y-5'>
                        ...
                        <div className='border border-2 rounded-md p-5 space-y-5'>
                            <details className='border-b-2 pb-3'>
                                ...
                                <div className='px-5 py-3 mt-2  '>
                                    <ul className='list-disc text-base text-gray-500 header-text-width space-y-3'>
                                        <li>২০২৪ সালের ৩য় থেকে ৫ম শ্রেণির শিক্ষার্থীদের জন্য</li>
                                    </ul>
                                </div>
                            </details>
                            <details className='border-b-2 pb-3'>
