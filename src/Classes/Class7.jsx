        ...
        <div className='container'>
            <div className='flex md:flex-row flex-col-reverse gap-5 mt-10 mb-10 '>
                ...
                <div className='flex flex-col gap-y-5'>
                    <h1 className='md:text-4xl text-2xl text-black font-bold'>২০২৪ শিক্ষাবর্ষের ৭ম শ্রেণীতে ভর্তি চলছে</h1>
                    <p className='text-base text-gray-500 header-text-width'>বাংলাদেশের যেকোনো প্রান্তের তৃ৭ম  শ্রেণির শিক্ষার্থীদের পড়লেখায় সাহায্য করতে, নতুন জাতীয় শিক্ষাক্রম অনুযায়ী পড়াশোনার সবকিছু নিয়ে সাজানো হয়েছে ৭ম  শ্রেণি - ব্যাচ ২০২৪।</p>
                            ...
                            <div className='md:grid md:grid-cols-2 grid grid-cols-1 gap-x-5 gap-y-2'>
                                ...
                                <div className='flex items-start gap-x-3'>
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <p className='text-black font-normal text-base text-width'>- ৭ম শ্রেণির পাঠ্যক্রমের বেসিক প্রিপারেশন যাচাই করার জন্য প্র্যাকটিস করতে পারবে</p>
                                    </div>
                                </div>
                            </div>
                            {/* 4rth */}
                    ...
                    <div className='space-y-5'>
                        ...
                        <div className='border border-2 rounded-md p-5 space-y-5'>
                            ...
                            <details className=''>
                                <summary className='text-zinc-600 text-[18px] font-semibold'>৭ম শ্রেণির শিখন বিষয়</summary>
                                <div className='px-5 py-3 mt-2'>
                                    <ul className='list-disc text-base text-gray-500 header-text-width space-y-3'>
